      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-5xl w-full grid grid-cols-1 md:grid-cols-2 overflow-hidden">
        ...
        <div className="hidden md:flex flex-col justify-center p-10 bg-gradient-to-br from-indigo-500 to-purple-600 text-white">
          <h1 className="text-4xl font-bold mb-4">
            Welcome Back{" "}
            <span className="text-white"> {loggedInUser.toUpperCase()}</span> 👋
          </h1>
          <p className="text-lg opacity-90">
            You are successfully logged in. Explore your dashboard and manage
        ...
        <div className="flex flex-col justify-center items-center p-10">
          {/* Image */}
          <img src="/Home.jpg" alt="Home Illustration" className="w-64 mb-6 " />

          <h2 className="text-3xl font-bold text-gray-800 mb-3">Home Page</h2>
          {/* <button><Link to="/login">Home route</Link></button> */}

          <p className="text-gray-500 mb-8 text-center max-w-sm">
            This is your personalized home page. Everything you need is just one
            click away.
          </p>
